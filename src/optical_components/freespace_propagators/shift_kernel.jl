function shift_kernel(fx::T, fy::T, θx::T, θy::T, z::Tp
...
function _propagate_core!(apply_kernel_fns::F, u::AbstractArray, p::ShiftKernel,
...
function ShiftProp(u::ScalarField, z::Real;
        use_cache::Bool = true,
        double_precision_kernel::Bool = use_cache)
